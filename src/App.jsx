...
const T = {
  ...
  accent:"#FF385C", accentL:"#FFF1F2", accentD:"#FF385C",
    ...
    <div style={{minHeight:"100vh",background:T.bg}}>
      ...
      <div style={{borderTop:"1px solid #EBEBEB",padding:"28px 24px"}}>
        <div style={{maxWidth:960,margin:"0 auto",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:12}}>
          ...
          <span style={{fontSize:12,color:T.light}}>Hecho con ❤️ en Chile · {new Date().getFullYear()} · <a href="/privacidad" style={{color:T.muted,textDecoration:"none"}}>Política de privacidad</a></span>
        </div>
      </div>
    </div>
  );
